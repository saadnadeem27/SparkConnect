                  ...
                  items: [
                    BottomNavigationBarItem(
                      icon: AnimatedContainer(
                        ...
                        padding: EdgeInsets.all(
                            navController.currentIndex == 0 ? 8 : 4),
                    ...
                    BottomNavigationBarItem(
                      icon: AnimatedContainer(
                        duration: const Duration(milliseconds: 300),
                        padding: EdgeInsets.all(
                            navController.currentIndex == 1 ? 8 : 4),
                    ...
                    BottomNavigationBarItem(
                      icon: AnimatedContainer(
                        duration: const Duration(milliseconds: 300),
                        padding: EdgeInsets.all(
                            navController.currentIndex == 2 ? 8 : 4),
                    ...
                    BottomNavigationBarItem(
                      icon: AnimatedContainer(
                        duration: const Duration(milliseconds: 300),
                        padding: EdgeInsets.all(
                            navController.currentIndex == 3 ? 8 : 4),
                    ...
                    BottomNavigationBarItem(
                      icon: AnimatedContainer(
                        duration: const Duration(milliseconds: 300),
                        padding: EdgeInsets.all(
                            navController.currentIndex == 4 ? 8 : 4),
